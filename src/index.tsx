...
function RootLayout() {
  ...
  const renderListMenu = () => {
    return (
      <div className="RootLayout-list-menu">
        <Menu mode="inline" onClick={handleChangeMenu} selectedKeys={[keyMenu]}>
          ...
          <Menu.Item key="bashProfile">Bash Profile</Menu.Item>
  ...
  const renderLeftContainer = () => {
    return (
      <div className="RootLayout-left-container">
        {renderListMenu()}
        {renderSearch()}
      </div>
    );
  ...
  const renderRightContainer = () => {
    return (
      <div className="RootLayout-right-container">
        <div className="RootLayout-main-content">{renderMainContent()}</div>
      </div>
    );
  };
